...
const project = {
  ...
  features: [
    {
      ...
      text: "Young people explore identity, confidence and emotion through movement.",
    },
    {
      icon: Users,
      title: "Positive community",
      text: "Groups create friendship, belonging and reduced isolation.",
    },
    {
      icon: Heart,
      title: "Wellbeing through creativity",
      text: "Dance links physical, emotional and social wellbeing.",
    },
    {
      icon: Zap,
      title: "Leadership pathways",
      text: "Young people can grow into peer support, coaching and leadership.",
    },
  ],
  ...
  steps: [
    {
      title: "Invite",
      text: "Young people join through school, community or peer connection.",
    },
    {
      title: "Belong",
      text: "A safe creative group builds friendship and confidence.",
    },
    {
      title: "Notice",
      text: "Trusted leaders spot needs and start supportive conversations.",
    },
    {
      title: "Support",
      text: "Young people are linked into mentoring, wellbeing support or groups.",
    },
    {
      title: "Lead",
      text: "Participants can grow into young leaders and peer encouragers.",
    },
  ],
